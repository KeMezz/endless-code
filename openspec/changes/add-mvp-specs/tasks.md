...
### 4.1 디렉토리 트리
- [ ] 4.1.1 FileTreeView - OutlineGroup 기반 트리 구조
- [ ] 4.1.2 FileTreeNode - 확장/축소 상태 관리
- [ ] 4.1.3 지연 로딩 - 폴더 확장 시 자식 노드만 로드
- [ ] 4.1.4 가상화 - 1,000개 이상 항목 시 뷰포트 렌더링
- [ ] 4.1.5 심볼릭 링크 처리 - 순환 참조 감지, 경고 표시
- [ ] 4.1.6 깊이 제한 - 50레벨 초과 시 경고
- [ ] 4.1.7 파일 타입별 아이콘 - SF Symbols 매핑
...
### 4.4 파일 검색
- [ ] 4.4.1 SearchField - 검색어 입력, 디바운싱 (300ms)
- [ ] 4.4.2 파일명 검색 - 부분 문자열 매칭
- [ ] 4.4.3 Fuzzy 매칭 - 약어 검색 지원 (예: "vc" → "ViewController")
- [ ] 4.4.4 검색 결과 하이라이팅

### 4.5 Section 4 E2E 테스트
- [ ] 4.5.1 디렉토리 트리 표시 및 탐색 테스트
- [ ] 4.5.2 파일 선택 및 내용 표시 테스트
- [ ] 4.5.3 파일 검색 테스트
