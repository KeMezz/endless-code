...
### 2.0 서버 통신 레이어
- [ ] 2.0.1 WebSocketClient - 연결/해제, 메시지 송수신
- [ ] 2.0.2 WebSocketClient - 자동 재연결 (지수 백오프)
- [ ] 2.0.3 ConnectionManager - 연결 상태 모니터링, 상태 이벤트 발행
- [ ] 2.0.4 MessageRouter - 수신 메시지 타입별 라우팅

### 2.1 앱 구조 설정
- [ ] 2.1.1 앱 구조 - NavigationSplitView, 탭 구조
- [ ] 2.1.2 앱 상태 관리 - @Observable 모델
- [ ] 2.1.3 라우터 - 화면 전환, 딥링크 처리

### 2.2 프로젝트 브라우저
- [ ] 2.2.1 프로젝트 목록 View
- [ ] 2.2.2 프로젝트 카드 컴포넌트
- [ ] 2.2.3 검색 - 이름 부분 문자열 매칭
- [ ] 2.2.4 필터링 - 경로 기반, 최근 사용 순

### 2.3 세션 목록
- [ ] 2.3.1 SessionListView - 활성 세션 표시
- [ ] 2.3.2 SessionCard - 상태 뱃지, 프로젝트 이름, 마지막 메시지
- [ ] 2.3.3 세션 전환 - 선택 시 채팅 뷰로 이동
- [ ] 2.3.4 세션 관리 - 일시정지, 종료 액션
