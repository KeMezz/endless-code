...
### 6.1 마크다운 뷰어
- [x] 6.1.1 MarkdownUI 통합 및 스타일링

### 6.2 대화형 프롬프트 UI
- [x] 6.2.1 PromptDialog - 질문 표시
- [x] 6.2.2 옵션 버튼 및 멀티 셀렉트
- [x] 6.2.3 직접 입력 필드

### 6.3 설정 화면
- [x] 6.3.1 SettingsView - 서버, CLI 경로 설정
- [x] 6.3.2 Keychain 토큰 관리

### 6.4 메뉴바
- [x] 6.4.1 MenuBarExtra - 서버 상태 아이콘 (활성/비활성/오류)
- [x] 6.4.2 상태 정보 표시 - 활성 세션 수, 연결된 클라이언트 수
- [x] 6.4.3 빠른 액션 - 새 세션, 최근 프로젝트, 서버 시작/중지
- [x] 6.4.4 서버 정보 - 주소 복사, 토큰 보기, QR 코드 생성
- [x] 6.4.5 에러 알림 - 배지 표시, 리소스 경고

### 6.5 Section 6 E2E 테스트
- [x] 6.5.1 마크다운 렌더링 테스트
- [x] 6.5.2 대화형 프롬프트 UI 테스트
- [x] 6.5.3 설정 화면 테스트
- [x] 6.5.4 메뉴바 테스트
...
### 7.1 서버 연결
- [x] 7.1.1 ServerSettingsView - 주소/토큰 입력
- [x] 7.1.2 연결 테스트 및 상태 표시
- [x] 7.1.3 Bonjour 서버 발견
- [x] 7.1.4 QR 코드 스캔 - 카메라 권한, 자동 연결
- [x] 7.1.5 로컬 네트워크 권한 - NSLocalNetworkUsageDescription

### 7.2 모바일 UI 적응
- [x] 7.2.1 탭 기반 네비게이션 구조
- [x] 7.2.2 채팅 뷰 모바일 최적화 - 키보드 대응
- [x] 7.2.3 코드 블록 - 가로 스크롤, 핀치 줌
- [x] 7.2.4 파일/Diff 뷰어 모바일 레이아웃

### 7.3 네트워크 처리
- [x] 7.3.1 연결 상태 모니터링 및 재연결
- [x] 7.3.2 백그라운드/포그라운드 전환 처리

### 7.4 오프라인 처리
- [x] 7.4.1 로컬 캐시 - 최근 세션 메시지 저장
- [x] 7.4.2 오프라인 UI - 연결 불가 상태 표시
- [x] 7.4.3 재연결 대기 - 진행률 표시, 수동 재시도 버튼

### 7.5 Section 7 E2E 테스트
- [x] 7.5.1 서버 연결 및 QR 스캔 테스트
- [x] 7.5.2 모바일 채팅 플로우 테스트
- [x] 7.5.3 오프라인/재연결 테스트
